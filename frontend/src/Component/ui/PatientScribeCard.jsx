...
const PatientScribeCard = ({ name, tab, onClick }) => {
  return (
    <div
      className="group relative w-32 h-24 xl:w-44 xl:h-24 bg-gray-300 rounded-b-lg flex justify-center items-center cursor-pointer hover:bg-gray-400 transition-colors mt-4"
      onClick={onClick}
    >
