...
const AddPatientUICard = () => {
  ...
  const cards = [
    { id: 1, content: "This is Card 1" },
    { id: 2, content: "This is Card 2" },
  ];
  ...
  return (
    <div className="flex flex-col items-center justify-center h-full bg-gray-100">
      <div className="bg-white w-[600px]">
        <header className="px-3 py-4 bg-bg-sb border border-b-f-gray rounded-t-lg">
          <h1 className="text-p-lg text-c-secondary font-semibold">
            Patient Information
          </h1>
        </header>
        <body className="h-[600px] overflow-y-scroll">
          {currentCardIndex == 0 ? (
            <div className="p-8">
        ...
        <footer className="px-3 py-6 bg-white border border-t-f-gray rounded-b-lg">
          {currentCardIndex == 0 ? (
            ""
          ) : (
            <button
