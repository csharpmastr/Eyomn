        ...
        <div data-custom-class="body">
              ...
              <strong>
                <span style={{ fontSize: "15px" }}>
                  <span data-custom-class="subtitle">
                    Last updated <bdt className="question">August 26, 2024</bdt>
                  </span>
                </span>
              </strong>
            </span>
          ...
          <div>
            ...
            <ul>
              <li data-custom-class="body_text" style={{ lineHeight: "1.5" }}>
                <span style={{ fontSize: "15px" }}>
                  Use <bdt className="question">Eyomn</bdt>.{" "}
                  <bdt className="question">
                    An AI-Powered platform that you can use to support your
                    analysis on Fundus Images, automate summarization of your
                    patient notes, and organize your patient's data in a safe
                    and efficient way.
                  </bdt>
                </span>
                <bdt className="statement-end-if-in-editor">
            ...
            <div style={{ lineHeight: "1.5" }}>
              ...
              <a
                data-custom-class="link"
                href="https://app.termly.io/notify/cb83497a-a563-4260-9b26-cf200673cbc9"
                                            ...
                                            <div style={{ lineHeight: "1.5" }}>
                                              ...
                                              >
                                                ...
                                                >
                                                  ...
                                                  <span data-custom-class="body_text">
                                                    otect the data they hold on
                                                    our behalf and to retain it
                                                    ...
                                                    >
                                                      ...
                                                      >
                                                        <span data-custom-class="body_text">
                                                          ...
                                                          AI Products in any way
                                                          that violates the
                                                          terms or policies of
                                                          any AI Service
                                                          Provider.
                                                        </span>
                                                        <bdt className="statement-end-if-in-editor" />
