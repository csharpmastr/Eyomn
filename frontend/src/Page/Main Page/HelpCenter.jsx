    ...
    <div className="text-f-dark p-3 md:p-8 font-Poppin h-full flex flex-col md:flex-row gap-8">
      <nav className="w-full md:w-1/3 flex flex-col justify-between h-full">
        <div>
          ...
          <div className="flex flex-row border border-c-gray3 px-4 rounded-md justify-center items-center w-full mt-6">
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="w-full bg-c-primary rounded-lg px-5 py-6  text-f-light">
            <section>
