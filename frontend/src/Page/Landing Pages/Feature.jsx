  ...
  return (
    <div className="bg-bg-prob2 h-auto pt-5">
      <div className="pt-16 pl-5 pr-2 mb-5 lg:text-center">
        <h1 className="font-Poppins text-[20px] font-bold text-prob-h mb-5  lg:text-[24px]">
          Provide Care with Eyomn
        </h1>
        <p className="font-Poppins text-[14px] text-paragraph lg:px-52 xl:px-[400px] ">
          Lorem ipsum dolor sit amet consectetur. Ornare volutpat cursus sed
          torto dignissim suscipit facilisis volutpat cursOrn.
        </p>
      </div>
